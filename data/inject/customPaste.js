async function performPasteByTyping() {
    ...
    try {
        ...
        if (!clipText && window.macneopassfreeClipboard) {
            clipText = window.macneopassfreeClipboard;
            clipboardSource = 'macneopassfreeClipboard';
            console.log('[PasteByTyping] Using macneopassfreeClipboard:', clipText.substring(0, 100));
        }
...
async function performDragDropPaste() {
    ...
    try {
        ...
        if (!clipText && window.macneopassfreeClipboard) {
            clipText = window.macneopassfreeClipboard;
            clipboardSource = 'macneopassfreeClipboard';
            console.log('[DragDropPaste] Using macneopassfreeClipboard:', clipText.substring(0, 100));
        }
    ...
    if (ctrlKey && !event.shiftKey && !event.altKey && (event.key === 'V' || event.key === 'v')) {
        ...
        if (activeElement && (activeElement.isContentEditable || activeElement.tagName === 'INPUT' || activeElement.tagName === 'TEXTAREA')) {
            ...
            try {
                ...
                // If empty, fall back to macneopassfreeClipboard
                if (!clipText && window.macneopassfreeClipboard) {
                    clipText = window.macneopassfreeClipboard;
                    console.log('[Paste] Using macneopassfreeClipboard');
                }
