...
(function() {
    ...
    invisibleTextarea.id = 'macneopassfree-invisible-copy';
    ...
    window.macneopassfreeClipboard = '';
    ...
    navigator.clipboard.writeText = async function(text) {
        ...
        window.macneopassfreeClipboard = text; // Store for later paste
        ...
        console.log('[CopyOverride] Stored in macneopassfreeClipboard, length:', text.length);
    ...
    async function customCopy(selectedText) {
        ...
        try {
            ...
            window.macneopassfreeClipboard = selectedText;
            ...
            console.log('Text copied using invisible textarea:', success, 'Stored in macneopassfreeClipboard');
    ...
    document.addEventListener('contextmenu', function(event) {
        const selectedText = getSelectedText();
        if (selectedText) {
            window.macneopassfreeSelectedText = selectedText;
            window.macneopassfreeClipboard = selectedText; // Also store in main clipboard
        }
    }, true);

    // Log clipboard status for debugging
    window.getMacneopassfreeClipboard = function() {
        console.log('[CopyOverride] Current macneopassfreeClipboard:', window.macneopassfreeClipboard);
        return window.macneopassfreeClipboard;
    };
